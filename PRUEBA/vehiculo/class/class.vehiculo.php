...
//************************************* PARTE II ****************************************************	
	...
	public function get_list(){
		...
		<table class="table table-hover" style="background-color:#f1fdf3;" border="1" align="center">
			...
			<tr>
				<th class="text-center" colspan="8" style="color:#f7f5f5; background-color:#6879C6"><a href="index.php?d=' . $d_new_final . '"class="text-center btn" style="color:#f7f5f5; background-color:#6d96b3"><b>Nuevo</b></a></th>
			</tr>
			<tr>
		...
		while($row = $res->fetch_assoc()){
			...
			$html .= '
				<tr>
					...
					<td>' . $row['anio'] . '</td>
					<td>' . $row['avaluo'] . '</td>
					<td class="text-center"><a href="index.php?d=' . $d_del_final . '"class="text-center btn" style="color:#000000; background-color:#6d96b3" ><b>Borrar</a></td>
					<td class="text-center"><a href="index.php?d=' . $d_act_final . '"class="text-center btn" style="color:#000000; background-color:#6d96b3" ><b>Actualizar</a></td>
					<td class="text-center"><a href="index.php?d=' . $d_det_final . '"class="text-center btn" style="color:#000000; background-color:#6d96b3" ><b>Detalle</a></td>
				</tr>';
		}
		$html .= '<tr>
